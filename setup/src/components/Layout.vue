  ...
  <div class="flex min-h-screen bg-gray-50 flex-col md:flex-row">
    ...
    >
      ...
      <div class="space-y-3">
        ...
        <nav class="space-y-2">
          <router-link to="/quick-setup" class="block">
            <button
              :class="[
          ...
          <router-link to="/upload-students" class="block">
            <button
              :class="[
                'w-full text-left px-4 py-3 rounded font-medium flex items-center space-x-3 transition-colors',
                $route.path === '/upload-students' 
                  ? 'bg-blue-100 border border-blue-200 text-blue-800' 
                  : 'bg-blue-50 text-blue-800 hover:bg-blue-100'
              ]"
            >
          ...
          <router-link to="/add-student" class="block">
            <button
              :class="[
                'w-full text-left px-4 py-3 rounded font-medium flex items-center space-x-3 transition-colors',
          ...
          <router-link to="/upload-instructors" class="block">
            <button
              :class="[
                'w-full text-left px-4 py-3 rounded font-medium flex items-center space-x-3 transition-colors',
                $route.path === '/upload-instructors' 
          ...
          <router-link to="/add-instructor" class="block">
            <button
              :class="[
                'w-full text-left px-4 py-3 rounded font-medium flex items-center space-x-3 transition-colors',
                $route.path === '/add-instructor' 
          ...
          <router-link to="/admin-settings" class="block">
            <button
              :class="[
                'w-full text-left px-4 py-3 rounded font-medium flex items-center space-x-3 transition-colors',
