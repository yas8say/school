  ...
  <div class="flex min-h-screen bg-gray-50 flex-col md:flex-row">
    ...
    >
      ...
      <nav class="space-y-3">
        ...
        <router-link to="/add-student" class="block"> <!-- this is OK -->
          <button class="w-full text-left px-4 py-2 rounded hover:bg-blue-100 bg-blue-50 text-blue-800 font-medium">
            Add Student
          </button>
        </router-link>
        <router-link to="/upload-instructors" class="block"> <!-- this is OK -->
          <button class="w-full text-left px-4 py-2 rounded hover:bg-blue-100 bg-blue-50 text-blue-800 font-medium">
            Upload Instructors
          </button>
        </router-link>
        <router-link to="/add-instructor" class="block"> <!-- this is OK -->
          <button class="w-full text-left px-4 py-2 rounded hover:bg-blue-100 bg-blue-50 text-blue-800 font-medium">
            Add Instructor
          </button>
        </router-link>
